...
👉 Back-end Developer / Desenvolvedor Web em formação
📍 São Paulo – SP, Brasil
...
Esse projeto tem como objetivo me apresentar como desenvolvedor e servir de cartão de visitas para oportunidades profissionais.

💻 Tecnologias Utilizadas

Principais linguagens e ferramentas usadas no projeto:
...
Início – Saudação e título profissional.

Sobre – Um pouco sobre mim e meus objetivos.

Habilidades – Skills técnicas e competências profissionais.

Projetos – Destaque para meus projetos (em breve com mais conteúdos).
